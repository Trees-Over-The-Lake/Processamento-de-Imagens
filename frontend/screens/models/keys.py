...
ABRIR_PASTA_BIRADS_KEY = '-BIRADS_IMAGES_FOLDER-'

# Treinar o modelo
TREINAR_MODELO_BUTTON_TEXT = 'Treinar modelo'
TREINAR_MODELO_KEY = '-TRAIN_MODEL-'
...
PREVER_IMAGENS_KEY = '-PREVIEW_MULTIPLE_IMAGES-'

# Recortar uma imagem e prever a classe da região
CORTAR_E_PREVER_IMAGEM_BUTTON_TEXT = 'Recortar uma região e identificar'
CORTAR_E_PREVER_IMAGEM_KEY = '-CROP_AND_PREDICT_IMAGE-'

# Obter métricas do modelo de classificação
OBTER_METRICAS_MODELO_BUTTON_TEXT = 'Obter métricas do modelo de classificação'
OBTER_METRICAS_MODELO_KEY = '-GET_MODEL_METRICS-'

# Opções avançadas
OPCOES_AVANCADAS_BUTTON_TEXT = 'Opções avançadas'
OPCOES_AVANCADAS_KEY = '-ADVANCED_OPTIONS-'

# Ajuda
AJUDA_BUTTON_TEXT = 'Ajuda'
AJUDA_KEY = '-HELP-'
# Créditos 
...
# Valor do número de cores
ADVANCED_OPTIONS_N_COLORS_SLIDER_KEY = '-ADVANCED_N_COLORS_KEY-'