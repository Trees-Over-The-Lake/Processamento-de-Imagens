...
layout_esquerda = [
    ...
    [sg.Button(keys.PREVER_IMAGEM_BUTTON_TEXT, key=keys.PREVER_IMAGEM_KEY, target=(-1, 0), size=window_config.get_button_size(), border_width=4, button_type=sg.BUTTON_TYPE_BROWSE_FILE)],
    [sg.Button(keys.PREVER_IMAGENS_BUTTON_TEXT, key=keys.PREVER_IMAGENS_KEY, size=window_config.get_button_size(), border_width=4)],
    [sg.Button(keys.CORTAR_E_PREVER_IMAGEM_BUTTON_TEXT, key=keys.CORTAR_E_PREVER_IMAGEM_KEY, size=window_config.get_button_size(), border_width=4)],
    [sg.Button(keys.OBTER_METRICAS_MODELO_BUTTON_TEXT, key=keys.OBTER_METRICAS_MODELO_KEY, size=window_config.get_button_size(), border_width=4)],
